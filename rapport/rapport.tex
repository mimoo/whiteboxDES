...
La tabularization consiste à transformer toutes les opérations en Lookup tables (qu'on peut représenter sous forme de S-box (Substitution boxes)).
...
8 lookup tables non linéaires qui permettent le xor avec la clef et la substitution en les précalculant grâce à la formule :
...
Après permutation, les lookup tables l
